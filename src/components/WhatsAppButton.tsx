...
export default function WhatsAppButton({ locale }: { locale: string }) {
  const message = locale === 'es' 
    ? 'Hola, me gustaría pedir información sobre estores a medida.' 
    : 'Hello, I would like to request information about made to measure blinds.';
    
  const phone = "34900000000";
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-colors z-50 flex items-center justify-center"
