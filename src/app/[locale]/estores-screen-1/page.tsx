      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Product",
            "name": locale === 'es' ? "Estor Enrollable Screen 1%" : "Screen 1% Roller Blind",
            "image": `https://estoresalicante.com/images/screen_1_percent.jpg`,
            "description": locale === 'es' ? "Estores enrollables screen del 1% de apertura. Privacidad máxima de día y protección térmica óptima en Alicante." : "Screen roller blinds with 1% openness. Maximum daytime privacy and optimal thermal protection in Alicante.",
            "offers": {
              "@type": "Offer",
              "priceCurrency": "EUR",
              "price": "24.00",
              "availability": "https://schema.org/InStock",
              "url": `https://estoresalicante.com/${locale}/estores-screen-1`
            },
            "aggregateRating": {
